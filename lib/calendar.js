    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          typeof this.props.prevMonthIcon === 'string' ? React.createElement('i', { className: this.props.prevMonthIcon }) : this.props.prevMonthIcon
        ),
        React.createElement(
          'span',
        ...
        React.createElement(
          ...
          typeof this.props.nextMonthIcon === 'string' ? React.createElement('i', { className: this.props.nextMonthIcon }) : this.props.nextMonthIcon
        )
      ),
      React.createElement(
        'table',
